...
import ElCheckbox from 'pl-table/packages/checkbox';
              ...
              >
                {
                  ...
                  {/*修改源码 当列的宽度小于内容了，不要换行显示，超出就省略符合 所以添加了个类pl-table-beyond*/}
                    <div class={[
                       'cell',
                       this.$parent.useVirtual && this.$parent.thtdBeyondHiding ? 'pl-table-beyond' : '', // 当我是大数据渲染模式 并且 开启了thtd超出隐藏，就开启超出隐藏
