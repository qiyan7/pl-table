...
```javascript
import Vue from 'vue';
import ElementUI from 'pl-table';
import 'pl-table/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'pl-table';
import App from './App.vue';
