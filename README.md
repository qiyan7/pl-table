...
> 当前版本我在npm上看见下载量600多，github上的star才90，希望大家给个Star吧。嘻嘻嘻
...
# pl-table表格的API
  https://github.com/livelyPeng/pl-table/wiki/Component-API
 ...
 **2.4.6**
 1.全新版本升级，基于用法一样，安装方式，引入方式发生变化，全新版本请看文档
